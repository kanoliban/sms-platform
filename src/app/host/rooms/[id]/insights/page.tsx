...
const MOCK_INSIGHTS: RoomInsights = {
  overview: {
    totalGuests: 24,
    confirmed: 6,
    conversionRate: 75,
    ...
    <div className="min-h-screen bg-[var(--bg-base)]">
      ...
      <PageContainer className="py-8">
        <div className="space-y-8">
          {/* Page Title */}
          <div>
            <h1 className="text-[var(--text-2xl)] font-bold text-[var(--text-primary)]">Room Insights</h1>
            <p className="text-[var(--text-sm)] text-[var(--text-muted)] mt-1">
              Track performance and engagement for {room.name}
            </p>
          </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              />
              <StatsCard
                label={`Confirmed (of ${room.capacity})`}
                ...
                <div>
                  ...
                  <ul className="text-[var(--text-sm)] text-[var(--text-secondary)] space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      Share your room on social media to attract new guests
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-4 h-4 text-[var(--primary)] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
