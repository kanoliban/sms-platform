...
function GuestListContent() {
  ...
  function invitationToGuestDetail(inv: InvitationWithUser): GuestDetail {
    return {
      ...
      spacesAttended: Math.floor(Math.random() * 5) + 1, // Demo data
          ...
          <Card className="p-6">
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between text-[var(--text-sm)] mb-2">
                ...
                <span className="text-[var(--text-muted)]">cap {space.capacity}</span>
              </div>
              <Progress value={(counts.going / space.capacity) * 100} size="sm" />
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <ActionCard
                ...
                label="Approvals"
                href={`/host/spaces/${spaceId}/approvals`}
                color="warning"
