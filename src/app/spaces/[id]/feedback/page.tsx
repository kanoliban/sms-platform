...
export default function FeedbackPage() {
  ...
  async function loadRoom() {
    ...
    try {
      ...
      if (spaceData) {
        ...
        if (spaceData.host) {
          setHost({
            name: spaceData.host.name,
            avatar: spaceData.host.avatar_url,
          });
        }
      }
    } catch (err) {
        ...
        <PageContainer className="py-16">
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="space-y-3">
              ...
              <Button variant="secondary" className="w-full" onClick={() => router.push(`/spaces/${spaceId}`)}>
                View Space Details
              </Button>
            </div>
          </div>
  ...
  // Format date
  const formattedDate = new Date(space.date).toLocaleDateString('en-US', {
    weekday: 'long',
    month: 'long',
    day: 'numeric',
  });
        ...
        <div className="max-w-lg mx-auto space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-[var(--text-base)] text-[var(--text-secondary)]">
              Share your feedback about {space.name}
            </p>
          </div>
