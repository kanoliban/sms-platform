...
export interface ReportSpaceModalProps {
  open: boolean;
  onClose: () => void;
  spaceId: string;
  spaceName: string;
...
export function ReportSpaceModal({
  ...
  const handleSubmit = useCallback(async () => {
    if (!reason.trim()) {
      toast({
        ...
        description: 'Tell us more about why you are reporting this space.',
      });
      return;
    }
  ...
  return (
    <Modal
      ...
      description="Please share more information about why you are reporting this space."
      footer={
