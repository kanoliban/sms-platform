...
export type RoomTone = 'chill' | 'playful' | 'deep' | 'intense';

export interface RoomCardProps extends HTMLAttributes<HTMLDivElement> {
  id: string;
  title: string;
  date: string;
  time: string;
...
const toneStyles: Record<RoomTone, { gradient: string; accent: string }> = {
  chill: {
